...
__DEFINE__(1662509556416, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1662509556417,"./event-store":1662509556418}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1662509556417, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1662509556418, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1662509556417,"./utils":1662509556419}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1662509556419, function(require, module, exports) {
...
return __REQUIRE__(1662509556416);
})()
